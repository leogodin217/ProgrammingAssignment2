## makeCacheMatrix(x=matrix()) Creates a matrix that can
## store its inverse.
##
## cacheSolve(x=makeCacheMatrix) Calculates the inverse of a
## matrix  and sets it in makeCacheMatrix or returns the cached
## value
